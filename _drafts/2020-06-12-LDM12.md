...
**1. 免載App、免打電話的計程車叫車服務**：在LINE上就能即時叫車。 

**2.介面簡單、操作流暢：**設定上車地點、開始叫車，行程結束後依跳錶金額付款最安心。 

**3. 支援多種支付方式：**可使用LINE Pay、LINE POINTS、信用卡、現金等方式，輕鬆付款，優雅下車。 

**4. 即時GPS行程紀錄：**行程當中可分享行車路線給親人、朋友，讓行程更有保障。 

**5. 雙向評分機制：**為確保服務品質，行程結束後，乘客/司機皆可對彼此評分，作為平台把關的重要依據。  
